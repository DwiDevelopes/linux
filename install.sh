...
function print_banner() {
    clear
    printf "${blue}#############    DG DEATH LINUX     ##############\n"
    printf "${blue}##                                88 8     ?    ##\n"
    printf "${blue}##  88888888"     888888888    88      db       ##\n"
    printf "${blue}##  88      db'   88         88  00  00   88    ##\n"
    printf "${blue}##  88       db'  88         88           88    ##\n"
    printf "${blue}##  88        db' 88    8888 99           88    ##\n"
    printf "${blue}##  88        db' 88       88  99         88    ##\n"
    printf "${blue}##  88       d8'  88       88   99  88  --1    ##\n"
    printf "${blue}##  88      d8'   88      88   888888888        ##\n"
    printf "${blue}##  88888888"     888888888                    ##\n"
    printf "${blue}##                                              ##\n"
    printf "${blue}####  ############# NetHunter DeAth ##############${reset}\n\n"
}
...
print_banner
printf "${green}[=] Kali NetHunter for Termux installed successfully log access dwi bakti n dev${reset}\n\n"
printf "${green}[+] To start Kali NetHunter Royhtml, type:${reset}\n"
